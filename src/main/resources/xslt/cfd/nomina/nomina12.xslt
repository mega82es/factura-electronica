...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nomina="http://www.sat.gob.mx/nomina">
  ...
  <xsl:template match="nomina:Nomina">
    ...
    <xsl:for-each select="./nomina:Emisor">
      <xsl:apply-templates select="."/>
    </xsl:for-each>

    <xsl:for-each select="./nomina:Receptor">
      <xsl:apply-templates select="."/>
    </xsl:for-each>

    <xsl:for-each select="./nomina:Percepciones">
      <xsl:apply-templates select="."/>
    </xsl:for-each>

    <xsl:for-each select="./nomina:Deducciones">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
    ...
    <xsl:for-each select="./nomina:OtrosPagos">
      <xsl:apply-templates select="."/>
    </xsl:for-each>

  </xsl:template>

  <xsl:template match="nomina:Emisor">
    <!--Manejador de nodos tipo nomina:Emisor-->
    <xsl:call-template name="Opcional">
    ...
    <!--  Iniciamos el tratamiento de los atributos de nomina:EntidadSNCF-->
    <xsl:for-each select="./nomina:EntidadSNCF">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
  ...
  <xsl:template match="nomina:EntidadSNCF">
  ...
  <xsl:template match="nomina:Receptor">
    <!--Manejador de nodos tipo nomina:Receptor-->
    <xsl:call-template name="Requerido">
      <xsl:with-param name="valor" select="./@Curp" />
    </xsl:call-template>
    <xsl:call-template name="Opcional">
    ...
    <!--  Iniciamos el tratamiento de los atributos de nomina:SubContratacion-->
    <xsl:for-each select="./nomina:SubContratacion">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
  ...
  <xsl:template match="nomina:SubContratacion">
    <!--  Iniciamos el manejo de los nodos dependientes -->
    <xsl:call-template name="Requerido">
  ...
  <xsl:template match="nomina:Percepciones">
    <!--Manejador de nodos tipo nomina:Percepciones-->
    <xsl:call-template name="Opcional">
    ...
    <!--  Iniciamos el tratamiento de los atributos de nomina:Percepcion-->
    <xsl:for-each select="./nomina:Percepcion">
      <xsl:apply-templates select="."/>
    </xsl:for-each>

    <!--  Iniciamos el tratamiento de los atributos de nomina:JubilacionPensionRetiro-->
    <xsl:for-each select="./nomina:JubilacionPensionRetiro">
      <xsl:apply-templates select="."/>
    </xsl:for-each>

    <!--  Iniciamos el tratamiento de los atributos de nomina:SeparacionIndemnizacion-->
    <xsl:for-each select="./nomina:SeparacionIndemnizacion">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
  ...
  <xsl:template match="nomina:Percepcion">
    <!--Manejador de nodos tipo nomina:Percepcion-->
    <xsl:call-template name="Requerido">
    ...
    <!--  Iniciamos el tratamiento de los atributos de nomina:AccionesOTitulos-->
    <xsl:for-each select="./nomina:AccionesOTitulos">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
    <!--  Iniciamos el tratamiento de los atributos de nomina:HorasExtra-->
  ...
  <xsl:template match="nomina:AccionesOTitulos">
    <!--  Iniciamos el manejo de los nodos dependientes -->
    <xsl:call-template name="Requerido">
  ...
  <xsl:template match="nomina:JubilacionPensionRetiro">
    <!--Manejador de nodos tipo nomina:JubilacionPensionRetiro-->
    <xsl:call-template name="Opcional">
  ...
  <xsl:template match="nomina:SeparacionIndemnizacion">
    <!--Manejador de nodos tipo nomina:JubilacionPensionRetiro-->
    <xsl:call-template name="Requerido">
  ...
  <xsl:template match="nomina:Deducciones">
    <!--Manejador de nodos tipo nomina:Deducciones-->
    <xsl:call-template name="Opcional">
    ...
    <!--  Iniciamos el tratamiento de los atributos de nomina:Deduccion-->
  ...
  <xsl:template match="nomina:Deduccion">
    <!--Manejador de nodos tipo nomina:Deduccion-->
    <xsl:call-template name="Requerido">
    ...
    <xsl:template match="nomina:OtrosPagos">

    <!--  Iniciamos el tratamiento de los atributos de nomina:OtroPago-->
    <xsl:for-each select="./nomina:OtroPago">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
  ...
  <xsl:template match="nomina:OtroPago">
    <!--Manejador de nodos tipo nomina:OtroPago-->
    <xsl:call-template name="Requerido">
    ...
    <!--  Iniciamos el tratamiento de los atributos de nomina:SubsidioAlEmpleo-->
    <xsl:for-each select="./nomina:SubsidioAlEmpleo">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
    <!--  Iniciamos el tratamiento de los atributos de nomina:CompensacionSaldosAFavor-->
    <xsl:for-each select="./nomina:CompensacionSaldosAFavor">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
  ...
  <xsl:template match="nomina:SubsidioAlEmpleo">
    <!--Manejador de nodos tipo nomina:SubsidioAlEmpleo-->
    <xsl:call-template name="Requerido">
  ...
  <xsl:template match="nomina:CompensacionSaldosAFavor">
    <!--Manejador de nodos tipo nomina:CompensacionSaldosAFavor-->
    <xsl:call-template name="Requerido">
  ...
  <xsl:template match="nomina:Incapacidades">
    <!--  Iniciamos el tratamiento de los atributos de nomina:Incapacidades-->
  ...
  <xsl:template match="nomina:Incapacidad">
    <!--Manejador de nodos tipo nomina:Incapacidad-->
    <xsl:call-template name="Requerido">
