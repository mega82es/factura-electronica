...
//import mx.bigdata.sat.cfdi.v33.schema.Comprobante.Emisor.RegimenFiscal;
...
//import mx.bigdata.sat.cfdi.v33.schema.TUbicacion;
//import mx.bigdata.sat.cfdi.v33.schema.TUbicacionFiscal;
...
public final class ExampleCFDv33Factory {
	...
	/**
	 * METODO MAIN PARA PROBAR DESARROLLO V33
	 */
	public static void main(String args[] ){
        ...
        try{
         ...
         File tempFile = File.createTempFile("ExampleCFDv33Factory", ".xml");
			FileOutputStream osTemp = new FileOutputStream(tempFile);
			cfd.guardar(osTemp);
  ...
  public static Comprobante createComprobante() throws Exception {
    ...
    GregorianCalendar gc = new GregorianCalendar(2016, 11, 26, 12, 54, 12);
    System.out.println("Fecha es: "+gc.getTime());
    DatatypeFactory dtf = DatatypeFactory.newInstance();
    XMLGregorianCalendar fecha = dtf.newXMLGregorianCalendar(gc);
    comp.setFecha(fecha);
  ...
  private static Emisor createEmisor(ObjectFactory of) {
   ...
   /* TUbicacionFiscal uf = of.createTUbicacionFiscal();
    ...
    // CFDI v3.3 RegimenFiscal pasa a ser un atributo de emisor
    emisor.setRegimenFiscal("simplificado");
